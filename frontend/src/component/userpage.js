...
function Userpage() {
  ...
  const validate = (values) => {
    ...
    Object.keys(errors).length
      ? (formErrors.main = 'Enter data properly')
      : (formErrors.main = '')
    return errors
  }
  const addOverlay = () => {
        ...
        <div className="adduser">
          <form>
            <div>
              ...
              <div>
                <label>
                  <span className="redstar">*</span>User Access
                </label>
              </div>
              <div className="gapbelow">
                <select
                  name="user_access"
                  id="user_access"
                  class="select-control2"
                  value={formValues.user_access}
                  onChange={handleChange}
                >
              ...
              <div>
                <label>
                  <span className="redstar">*</span>User Status
                </label>
              </div>
              <select
                name="user_status"
              ...
              ></input>
              <Link to="/user" className="linker" onClick={handleOnRequestESC}>
                Cancel
              </Link>
              <br />
            </div>
  ...
  return (
    <>
      ...
      <div className="linkgaps">
        ...
        <Link to="" className="linker" onClick={handleTriggerFullScreenOverlay}>
          <FiPlus />
          Add User
        </Link>
        <Link to="" className="linker">
