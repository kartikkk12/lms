...
import {
  removeSelectedJourney,
  selectedJourney,
} from '../redux/actions/Journey_actions'

function JourneyRedux() {
  const { id } = useParams()
  ...
  const singleJ = useSelector((state) => state.singleJourney)
  // useEffect(() => {
  ...
  //     dispatch(selectedJourney(response.data))
  //   })
  // }, [id])
  useEffect(() => {
    ...
    fetchData()
    return () => {
      dispatch(removeSelectedJourney())
    }
  }, [id])
  ...
  //   e.preventDefault()
  //   axios
  //     .post('http://localhost:3000/journey/create', {
  //       journey: {
  ...
  const handleaddmore = () => {
    // setStageForm([
    //   ...stageForm,
    //   { stage_name: '', overview_message: '', completion_message: '' },
    // ])
              ...
              <div className="journeyform">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="overview_message"
                    value={singleJ.overview_message}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    value={singleJ.completion_message}
                ...
                {/* <h4><AiFillDelete/></h4> */}
                {singleJ.stages &&
                  singleJ.stages.map((input, index) => {
                    return (
                      <div key={index} className="collapsible">
                        <div className="headerx">
                          {isExpanded ? (
                            <span {...getToggleProps()}>
                              {singleJ.stages[index].stage_name.length
                                ? singleJ.stages[index].stage_name
                                : 'Untitled ' + (index + 1)}
                            </span>
                          ) : (
                            <span {...getToggleProps()}>
                                ...
                                <div className="journeyform">
                                  <div className="form-group">
                                    <label
                                      ...
                                      htmlFor="stage_name"
                                    >
                                      <span className="redstar">*</span>Stage
                                      Name{' '}
                                    </label>
                                    <br />
                                    ...
                                    <input
                                      ...
                                      name="stage_name"
                                      id="stage_name"
                                      value={singleJ.stages[index].stage_name}
                                  ...
                                  <div className="form-group">
                                    ...
                                    <input
                                      ...
                                      name="overview_message"
                                      value={
                                        singleJ.stages[index].overview_message
                                      }
                                      id="overview_message"
                                  ...
                                  <div className="form-group">
                                    ...
                                    <input
                                      ...
                                      name="completion_message"
                                      value={
                                        singleJ.stages[index].completion_message
                                      }
                                      id="completion_message"
                                  ...
                                  <div>
                                    <table>
                                      ...
                                      <tbody>
                                        {singleJ.stages[index].activities
                                          .length > 0 ? (
                                          singleJ.stages[index].activities.map(
                                            (user) => {
                                              return (
                                                <tr>
                                                  <td className="centerx">
                                                    {user.activity_data}
                                                  </td>
                                                  <td className="centerx">
                                                    {user.activity_type}
